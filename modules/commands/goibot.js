...
module.exports.handleEvent = function({ api, event }) {
  ...
  if ((event.body.toLowerCase() == "bot ngu")) {
    return api.sendMessage("Thành viên đã cố ý chửi bot, do đó đã vi phạm luật bot nên bot sẽ out và muốn add lại thì xin liên hệ qua admin qua Fb: Hoàng Văn Cường để được hỗ trợ\nLink fb nè: https://www.facebook.com/profile.php?id=100007922737857", threadID, () =>
